...
export default function HeroSlider({ data }) {
  ...
  return (
    <>
      ...
      <div className="cs_slider_navigation d-flex cs_row_gap_20 flex-column position-absolute cs_zindex_4"
      style={{transform:"translateX(200px)"}}>
        <div
          className="cs_slider_btn filter cs_height_45 cs_width_45 bg-white rounded-circle d-flex align-items-center justify-content-center bg-accent-hover cs_transition_6"
          onClick={previous}
        >
          <svg
            width={20}
