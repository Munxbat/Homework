                        ...
                        <div className="container-fluid">
                            <div className="slide-content">
                                <div className="slide-title">
                                    <h2>Build More Together <br /> <span>OPTIMIZE INC</span></h2>
                                </div>
                                <div className="slide-text">
                                    <p>We Create Solutions That Drive Success</p>
                                </div>
                                <div className="clearfix"></div>
                                <div className="slide-btns">
                                    <ul>
                                        <li><Link onClick={ClickHandler} className="theme-btn-s2" to="/contact">Get a Quote</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
